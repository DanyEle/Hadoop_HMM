...
public class HMM
{
	public static class NewMapper extends Mapper<NullWritable, BytesWritable, Text, LogFile>
	{
		...
		{			
			...
			System.out.println("Amount of messages after removing outliers: " + logFile.messages.size());
			//now group messages based on their sequence IDs.
			seqIDStart = Utilities.extraSeqIDFromFilePath(filePath);
			//EX: Sequence ID 31 --> 31.000.000. This is done to avoid having sequenceIDs overlapping
			//from different files
			seqIDStart *= seqIDMultiplier;			
